...
<div class="main">
    <div class="header">
        <div class="header_resize">
            <div class="logo">
                <h3>
                    <a href="#">OPTIMIZING APP ALERTS FOR <br /><small>A SUPERIOR E-COMMERCE EXPERIENCE</small></a>
                </h3>
            </div>
            <div class="menu_nav">
                <ul>
    ...
    <div class="content">
        <div class="content_resize">
            ...
            <div class="sidebar">
                <div class="gadget">
                    <h2>Apps Registration</h2>
                    <form name="register" action="AppsRegAction.jsp" method="post">
                        <table cellpadding="10">
                            <tr>
                                <th>Select App</th>
                                <td>
                                    <select name="apps" required style="width:170px;">
                                        <option value="">Select App</option>
                                        <option value="Flipkart">Flipkart</option>
                                        <option value="Amazon">Amazon</option>
                                    </select>
